 ...
 * @author kmdav
 */
public class RegisterLocation extends javax.swing.JFrame {

    /**
     * Creates new form RegisterLocation
     */
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        s.addL(jTextField1.getText());
        JOptionPane.showMessageDialog(rootPane, "Lokasi berhasil ditambahkan.");
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterLocation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
